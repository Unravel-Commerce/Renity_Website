...
**Official copy (when the website is live):** [https://www.renityapp.com/terms-of-service](https://www.renityapp.com/terms-of-service) — use the same text as this document for App Store, Google Play, and the App.

These **Terms** govern your use of **Renity** (the “**App**”). By using the App, you agree to them. If you don’t agree, don’t use the App.
...
## 12. You covering our costs (indemnity)
...
If one part of these Terms is invalid, the rest stays. We may assign our side of the agreement; you may not, without our consent. The **English** version wins if translations disagree (if you add translations later).
...
**Web:** [renityapp.com](https://www.renityapp.com) (terms page when the site is live: `/terms-of-service` or as you configure it)
